"""CLI entrypoint for expansion-first systematic allocation research."""
from __future__ import annotations

import argparse
from pathlib import Path

from crypto_mlsystem.expansion_first_research import run_expansion_first_research, write_expansion_first_reports
from crypto_mlsystem.macro_regime_benchmark_analysis import load_default_inputs


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the standalone expansion-first allocation research study.")
    ...
    parser.add_argument("--output-dir", default="reports/expansion_first_research", help="Output report directory.")
...
def main() -> None:
    ...
    write_expansion_first_reports(args.output_dir, result)
    print(f"Expansion-first research reports written to {Path(args.output_dir)}")

"""CLI entrypoint for New-Data Upside Expansion Strategy research."""
...
from crypto_mlsystem.new_data_expansion_strategy import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run new-data upside expansion inventory, feature research, and gated overlay.")
    ...
    parser.add_argument("--processed-dir", default="data/processed/new_data_expansion", help="Small downloaded public-source cache.")
    parser.add_argument("--output-dir", default="reports/new_data_expansion_strategy", help="Output report directory.")
...
def main() -> None:
    ...
    result = run_new_data_expansion_strategy(panel, macro, public_data, probability, processed_dir=args.processed_dir)
    write_new_data_expansion_reports(args.output_dir, result)
    print(f"New-data expansion reports written to {Path(args.output_dir)}")

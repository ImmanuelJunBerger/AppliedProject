"""CLI entrypoint for macro-regime strategy enhancement research."""
...
from crypto_mlsystem.strategy_enhancement_research import (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run economically motivated enhancement studies around frozen btc_eth_macro_gate_balanced."
    )
    ...
    parser.add_argument(
        "--output-dir",
        default="reports/strategy_enhancement_research",
...
def main() -> None:
    ...
    write_strategy_enhancement_reports(args.output_dir, result)
    print(f"Strategy enhancement reports written to {Path(args.output_dir)}")
